...
public class CharacterSkinCollect : MonoBehaviour
{
    ...
    public void SampleCharacterResult()
    {
        //0~3 앞
        //4~7 뒤
        //8~11 오른쪽
        //12~15 왼쪽
        if (direction == 0) directionResult = 0;
        else if (direction == 1) directionResult = 8;
        else if (direction == 2) directionResult = 4;
        else if (direction == 3) directionResult = 12;
        else directionResult = 0;
    }
    ...
    public void UpdateSkinColor()
    {
        ...
        if (sprites.Length > 0)
            skinRenderer.sprite = sprites[directionResult];
    }
    ...
    public void UpdateHair()
    {
        ...
        if (sprites.Length > 0)
            hairRenderer.sprite = sprites[directionResult];
    }
    ...
    public void UpdateEyeColor()
    {
        ...
        if (sprites.Length > 0)
            eyeRenderer.sprite = sprites[directionResult];
    }
    ...
    public void UpdateClothes()
    {
        ...
        if (sprites.Length > 0)
            clothesRenderer.sprite = sprites[directionResult];
    }
    ...
    public void UpdateBeardOn()
    {
        ...
        if (sprites.Length > 0)
            beardRenderer.sprite = sprites[directionResult];
    }
}
